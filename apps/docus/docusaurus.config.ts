...
const config: Config = {
  ...
  url: 'https://trustswap.intuition.box',
  ...
  organizationName: 'TrustSwap', // Usually your GitHub org/user name.
  projectName: 'TrustSwap', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/intuition-box/TrustSwap/tree/dev/apps/docus/',
        },
        blog: {
          showReadingTime: true,
          blogTitle: 'Blog Trust',
          feedOptions: {
            type: ['rss', 'atom'],
            xslt: true,
          },
